...
$( document ).ready( function() {
  ...
  new ScrollMagic.Scene( {
    ...
    // Tile 14
    new ScrollMagic.Scene( {
      triggerElement: ".tile14", duration: "200%", triggerHook: 0
    } )
      .setPin( ".tile14" )
    ...
    new ScrollMagic.Scene( {
      triggerElement: ".tile14", duration: "200%", triggerHook: 0, offset: 0
    } )
  ...
  new ScrollMagic.Scene( {
    triggerElement: ".tile8", duration: "70%", triggerHook: 0.9
  } )
...
// Youtube Video Popup
const scriptUrl = 'https:\/\/www.youtube.com\/s\/player\/9f996d3e\/www-widgetapi.vflset\/www-widgetapi.js';if(!window["YT"])var YT={loading:0,loaded:0};if(!window["YTConfig"])var YTConfig={"host":"https://www.youtube.com"};
